...
void cpmld::Initial(unsigned nx, unsigned ny, unsigned nz, unsigned ncpml) {
...
void cpmld::createCPMLArray() {
    createPsi();
    createDen();
    createCBKAP();
}

void cpmld::createDen() {
